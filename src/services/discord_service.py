...
async def post_to_discord(
    ...
    embed = {
        ...
        if video_url and reddit_url
        else "",  # Double newline between URLs
        "color": color,
    ...
    webhook_data = {"username": username, "avatar_url": avatar_url, "embeds": [embed]}
...
async def post_mp4_link(
    title: str, mp4_url: str, team_data: Optional[Dict] = None
) -> bool:
